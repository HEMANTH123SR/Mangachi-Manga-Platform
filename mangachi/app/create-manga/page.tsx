  ...
  return (
    ...
    <div className=" grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 lg:mx-12">
      ...
      <div className="sm:col-span-6">
        ...
        {
          error && <p className="my-2 text-xs text-red-600">{errormessage?.mangaName?.[0]}</p>
        }
        <div className="mt-1">
      ...
      <div className="sm:col-span-6">
        ...
        {
          error && <p className="my-2 text-xs text-red-600">{errormessage?.author?.[0]}</p>
        }
        <div className="mt-1">
      ...
      <div className="sm:col-span-6">
        ...
        {
          error && <p className="my-2 text-xs text-red-600">{errormessage?.description?.[0]}</p>
        }
        <div className="mt-1">
          <Textarea
            id="description"
