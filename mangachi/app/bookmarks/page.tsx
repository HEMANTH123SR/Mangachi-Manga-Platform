...
const Bookmarks = () => {
        ...
        return (
            <div className="flex flex-col space-y-1 w-full justify-center items-center mt-6  ">
                ...
                {bookMarkedMangas.length < 1 && (
                    <span className=" text-xl sm:text-2xl font-semibold w-10/12">you have zero bookmarks</span>
                )}
    ...
    return <div className="flex w-full h-screen justify-center items-center"><span className="text-xl font-semibold">Loading</span></div>
};
