...
export const HomePageShonenContentSkelton = () => {
    return (
...
export const SpotLightCarsoulSkelton = () => {
    return (
        <div className="flex w-full my-5">
            <div className="w-2/5 sm:w-1/4 flex justify-center  mx-6">
                <Skeleton className="h-30 w-11/12 rounded-lg shadow-lg" />
            </div>
            <div
...
export const HorizontalScrollComponentSkelton = () => {
    return (
...
export const MangaPageSkeleton = () => {
    return (
